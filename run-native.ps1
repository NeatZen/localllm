# Run Odysseus natively on Windows (no Docker).
...
Write-Host "Starting Odysseus at http://127.0.0.1:7000"
Write-Host "Built-in local AI starts automatically on first boot (no Ollama needed)."
Write-Host "Stop Docker Odysseus first if port 7000 is busy: docker compose down"
