"""scripts/_lib/cli.py — shared scaffolding for the `neatai-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("neatai-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/neatai-foo`
...
VERSION = "0.1.0"  # bumped centrally; every neatai-* CLI reports this
