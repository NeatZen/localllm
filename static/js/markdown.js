...
function initMermaid() {
  if (!window.mermaid || window.__neataiMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__neataiMermaidReady = true;
}
window.neataiInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'neatai-thinking-expanded';
