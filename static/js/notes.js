...
let _searchQuery = '';
let _viewMode = (typeof localStorage !== 'undefined' && localStorage.getItem('neatai-notes-view')) || 'list'; // 'list' or 'grid'
...
const REMINDER_FIRED_KEY = 'neatai-notes-reminder-fired';
...
const REMINDER_GLOWED_KEY = 'neatai-notes-reminder-glowed';
...
const REMINDER_PENDING_HIGHLIGHT_KEY = 'neatai-notes-reminder-pending-highlight';
const REMINDER_ACTIVE_HIGHLIGHT_KEY = 'neatai-notes-reminder-active-highlight';
...
const REMINDER_DISMISSED_AT_KEY = 'neatai-notes-reminder-dismissed-at';
const NOTES_FIRST_OPEN_HINT_KEY = 'neatai-notes-first-open-hint-v1';
...
export function openPanel() {
  ...
  if (viewBtn) {
    ...
    viewBtn.addEventListener('click', () => {
      ...
      try { localStorage.setItem('neatai-notes-view', _viewMode); } catch {}
      pane.classList.toggle('notes-view-grid', _viewMode === 'grid');
      _setViewLabel();
      requestAnimationFrame(() => _applyMasonry(document.querySelector('#notes-pane .notes-pane-body')));
    });
...
const _DRAFT_PREFIX = 'neatai-note-draft-';
