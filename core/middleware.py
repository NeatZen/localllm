...
INTERNAL_TOOL_TOKEN = os.environ.get("NEATAIEUS_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-NeatAi-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-NeatAi-Internal-Token), or
